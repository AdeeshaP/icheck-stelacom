...
class VisitPreviewScreen extends StatefulWidget {
  ...
  @override
  State<VisitPreviewScreen> createState() => _CheckInScreenState();
}

class _CheckInScreenState extends State<VisitPreviewScreen>
  ...
  void saveAction(imagePath, accuracy, hignAccuracy) async {
    ...
    closeDialog(context);
    print("response visit ${r.statusCode}");
    if (r.statusCode == 200) {
      await showDialog(
