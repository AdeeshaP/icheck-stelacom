...
import 'package:icheck_stelacom/models/device_item.dart'; // Updated model
...
class VerificationResultsTwoScreen extends StatefulWidget {
  final int index;
  final List<DeviceItem> deviceList;
  final Function(List<DeviceItem>)? onDeviceListUpdated;

  const VerificationResultsTwoScreen({
    super.key,
    required this.index,
  ...
  @override
  _VerificationResultsTwoScreenState createState() =>
      _VerificationResultsTwoScreenState();
}

class _VerificationResultsTwoScreenState
    extends State<VerificationResultsTwoScreen> {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              if (item.serialNo != null) Text('Serial: ${item.serialNo}'),
              ...
              SizedBox(
                ...
                height: Responsive.isMobileSmall(context) ||
                    ...
                    : Responsive.isTabletPortrait(context)
                        ...
                        : 100,
                child: userObj != null &&
                        userObj!['CompanyProfileImage'] != null
                    ? CachedNetworkImage(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 3),
                Text('• Serialized: $serializedCount items'),
                SizedBox(height: 3),
                Text('• Non-serialized: $nonSerializedCount items'),
                SizedBox(height: 3),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorBorder: OutlineInputBorder(
                      borderSide:
                          BorderSide(color: Color.fromARGB(255, 216, 16, 2)),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    focusedBorder: OutlineInputBorder(
