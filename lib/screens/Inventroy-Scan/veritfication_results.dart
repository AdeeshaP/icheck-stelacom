...
class _VerificationResultsScreenState extends State<VerificationResultsScreen> {
  ...
  void _showRescanDialog(IMEIItem item) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Rescan Item'),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              SizedBox(height: 16),
              Text(
                  'This will take you back to the scanner to retry verification for this item.'),
            ],
          ),
          actions: [
            TextButton(
            ...
            ElevatedButton(
              ...
              child:
                  Text('Rescan', style: TextStyle(fontWeight: FontWeight.w600)),
            ),
          ],
        );
      },
