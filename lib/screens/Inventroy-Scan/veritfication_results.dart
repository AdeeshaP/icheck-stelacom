...
//   final Function(List<IMEIItem>)? onImeiListUpdated; // Add callback

//   const VerificationResultsScreen({
//     super.key,
//     required this.index,
//     required this.imeiList,
//     this.onImeiListUpdated,
//   });
...
//     return WillPopScope(
//       onWillPop: () async {
//         // Return the updated IMEI list when any back action is triggered
//         Navigator.of(context).pop(imeiList);
//         return false; // Don't perform default back action since we handled it
//       },
//       child: Scaffold(
//         appBar: AppBar(
...
//                                       ? 31
//                                       : 35),
//                       onPressed: () => Navigator.of(context).pop(imeiList),
//                     ),
//                     Expanded(
//                       flex: 6,
//                       child: Text(
...
//                   ),
//                 );
//                // Return updated list when submitting
//               Navigator.of(context).pop(imeiList);
//               },
//               child: Text('Submit'),
//               style: ElevatedButton.styleFrom(
