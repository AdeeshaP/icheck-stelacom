...
class CheckoutCapture extends StatefulWidget {
  const CheckoutCapture({Key? key}) : super(key: key);

  @override
  State<CheckoutCapture> createState() => _CheckoutCaptureState();
}

class _CheckoutCaptureState extends State<CheckoutCapture>
