...
class CheckinPreviewScreen extends StatefulWidget {
  ...
  @override
  State<CheckinPreviewScreen> createState() => _CheckInScreenState();
}

class _CheckInScreenState extends State<CheckinPreviewScreen>
  ...
  void saveAction(imagePath, accuracy, hignAccuracy) async {
    print("location address is ${appState.locationAddress}");
    print("latitude is ${lat.toString()}");
    print("longitude is ${long.toString()}");
  ...
  void updateLastCheckDataInLocalStorage() async {
    try {
      ...
      if (response != null && response.statusCode == 200) {
        ...
        //   MaterialPageRoute(
        //     builder: (context) => Home2(index2: 0),
        //   ),
        // );
